...
/* , 1/(1+exp(-(-0.03588230636718274*(0.0+ calculated PSC_act_age+ calculated PSC_act_cc+ calculated PSC_app_number_of_children+ calculated PSC_act_ccss_n_statC+ calculated PSC_act_ccss_maxdue+ calculated PSC_act9_n_arrears)+(18.57030237260953)))) as PD */ 
